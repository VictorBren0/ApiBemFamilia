...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('categoria_podcasts', {
      id: {
      ...
      podcast_id: {
        type: Sequelize.INTEGER,
        allowNull: false,
        references: { model: 'podcasts', key: 'id' }, //FAZ UMA REFERENCIA COM A OUTRA TABELA (chave estrangeira)
        onUpdate: 'CASCADE', //SE ATUALIZAR O ID ELE ATUALIZA TBM
        onDelete: 'CASCADE', //SE FOR DELETADO O ID ELE DELETADA TBM
      },
      created_at: {
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('categoria_podcasts')
  },
}
